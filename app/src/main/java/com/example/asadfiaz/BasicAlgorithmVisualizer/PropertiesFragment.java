...
public class PropertiesFragment extends Fragment {
    ...
    String url = "https://universityfyp2017.000webhostapp.com/encodePropertiesAlgo.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txtProperties = (TextView) view.findViewById(R.id.txtProperties);
        loadIntroduction();
        Typeface font = Typeface.createFromAsset(getActivity().getAssets(), "fonts/kottaone-regular.ttf");
        txtProperties.setTypeface(font);
