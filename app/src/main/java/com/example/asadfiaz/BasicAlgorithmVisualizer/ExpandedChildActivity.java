...
import static com.example.asadfiaz.BasicAlgorithmVisualizer.Login.userEmail;
...
public class ExpandedChildActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(bundle.getString("childname"));
        ...
        userEmailAddress.setText(userEmail.toLowerCase());
...
//    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_text) {
            ...
            transaction.replace(R.id.content_layout,new TextualFragment());
            transaction.commit();
